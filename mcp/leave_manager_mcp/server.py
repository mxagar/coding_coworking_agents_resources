...
DB_FILE = pathlib.Path(__file__).parent / "leave_manager.db"
...
### -- MCP Resources: Read-only data that can be accessed by agents, tools, or users
...
### -- MCP Tools: tools can modify data, while resources are read-only
